...
void frog::move_up(RenderWindow& window)
{

	if (alive && frogShape.getPosition().y > 100)
	{
		if (!( frogShape.getPosition().x == 100 && frogShape.getPosition().y == 550) && !(frogShape.getPosition().x == 1050 && frogShape.getPosition().y == 550))
		frogShape.move(0, -step);
	}
}
void frog::move_down(RenderWindow& window)
{
...
void frog::move_right(RenderWindow& window)
{
...
void frog::move_left(RenderWindow& window)
{
